...
<head>
    ...
    <link rel="icon" type="image/png" href="../img/logokuning.png">
    ...
    <div class="col-md-12 content">
        <div class="dashhead">
            <div class="dashhead-titles">
                ...
                <?php echo$name ?> | <a class="btn btn-success text-dark" href="../index.html">HOME</a><br/>
                <!-- <?php echo$vote_url ?> -->
                </h2>
            </div>
        </div>
...
<div class="row">
    <div class="col-md-12 content"> 
        <div class="statcard statcard-info p-4 mb-4">
            <h2 class="statcard-desc">Connect Server</h2>
            <h3 class="statcard-number">
                <input type="text" readonly value= "<?php echo$ip ?>  " class="no-style" onclick="this.select()" style="width:290px" id="ip"/>
                <a href="fivem://connect/<?php echo$ip ?>:<?php echo$port?>" class="btn btn-light text-dark">PLAY</a>
            </h3>
        </div>
    </div>
</div>
